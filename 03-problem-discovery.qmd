...
1. **5 problem interviews completed**: Use The Mom Test approach
2. **Interview synthesis on portfolio**: Use the template above
3. **Problem statement locked**: One clear sentence
4. **Target customer defined**: Include a persona
5. **v0.1 prototype deployed**: With Supabase auth

Start interviewing this week. You can interview:
- Friends who fit your target profile
- Classmates with relevant experiences
- People in relevant online communities
- Family members (if they actually experience the problem!)

Remember: you're not selling. You're learning. Ask about their life, not your idea.
