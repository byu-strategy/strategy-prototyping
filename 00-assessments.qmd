...
::: {.callout-note title="Problem Discovery Framework" collapse="true"}
...
Not every product needs all three. Pure tools (Uber, Amazon) may only expand agency — that's fine. The question is directional: for the needs you DO touch, are you on the right side?
