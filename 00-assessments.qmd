...
Now that you've built a working MVP, it's time to deeply understand what you've created. This assignment asks you to reverse-engineer your own application, document its architecture visually, and explain how all the pieces work together.

**Requirements**

1. **Code Base Analysis** - Use AI to systematically analyze your application:
   - Project structure and file organization
   - Complete data flow tracing
   - Architecture patterns and design decisions
   - External dependencies and integrations

2. **Architecture Diagram** - Create an annotated visual diagram showing:
   - Frontend components and user interface
   - Backend API endpoints and logic
   - Database schema and relationships
   - External services (Vercel, Supabase, Stripe, etc.)
   - Data flow arrows for key user actions
   - Authentication and payment flows

3. **Video Walkthrough** - Record a 2-3 minute screen recording where you:
   - Introduce your app and its purpose
   - Walk through your architecture diagram
   - Trace one complete user journey through the system (e.g., signup → purchase → dashboard)
   - Explain what you learned from this analysis

**Deliverables**

Submit via LearningSuite:
1. Your annotated architecture diagram (PDF or PNG)
2. Link to your video walkthrough (or video file if LearningSuite accepts uploads)

**Grading Rubric**

| **Category** | **Description** | **Points** |
|---------------|-----------------|-------------|
| **1. Architecture Diagram Quality** | Comprehensive, clear diagram with all required components and annotations | **0-20** |
| **2. Technical Understanding** | Accurate explanation of architecture and data flows in video | **0-12** |
| **3. Communication & Clarity** | Well-organized, clear verbal explanation within time limit | **0-5** |
| **4. Professionalism** | Proper submission format, working links, polished deliverables | **0-3** |
|  |  | **Total: 40 Points** |

This assignment is worth 40 points which equates to 8% of your grade.

**Why This Matters**: As a product manager working with engineering teams, you need to understand system architecture to make informed decisions about features, technical debt, scalability, and resource allocation. This assignment bridges the gap between "I built something with AI" and "I understand how systems work."
