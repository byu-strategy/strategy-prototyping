...
Here's the good news: you don't need to conduct elaborate market research to find a problem worth solving. You're surrounded by problems every day—you just need to notice them.
...
- "Spent 20 minutes trying to split a dinner bill with friends—everyone uses different payment apps"
...
A `CLAUDE.md` file (or `.claude/CLAUDE.md`) is a special file that Claude Code automatically reads when you start a session. It tells Claude about your project—what you're building, your preferences, and any important context.
...
## Development Notes
- Keep the UI simple—this is for personal use
...
> Build a simple Streamlit app for tracking problems. It should let me add a problem (title, description, frequency rating), see a list of all problems I've added, and save everything to a JSON file. Keep it minimal—this is just for me to capture ideas.
