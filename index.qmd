...
AI Tools:
- We will be using [Claude Code](https://www.anthropic.com/claude-code) throughout the course. Using Claude Code requires a paid Claude account (~\$20 per month for the duration of the semester). Your total cost will be about \$85 after tax
- Gemini is [free for students](https://gemini.google/students/) this year: 
