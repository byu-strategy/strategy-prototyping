...
There are no formal prerequisites for the course, but students should have an interest in going deep on a techincal level into AI tools. Prior programming experience is helpful but not expected.

## Required Materials

Paid account to an AI tool to be determined by you in class. Expect \$20 per month for the duration of the semester, about \$80 total for the course. This is comparable to typical textbook fee for a course. 
